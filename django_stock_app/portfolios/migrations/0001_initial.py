    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="User portfolio name", max_length=20),
                ),
                (
                    "create_date",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock",
                    models.CharField(help_text="Company Abbreviation", max_length=10),
                ),
                (
                    "amount",
                    models.IntegerField(help_text="Number of stocks in portfolio"),
                ),
                (
                    "stock_price",
                    models.DecimalField(
                        decimal_places=2, help_text="Average stock price", max_digits=15
                    ),
                ),
                (
                    "stock_buy_date",
