...
class BuyStockPortfolioForm(forms.ModelForm):
    ...
    stock = forms.ModelChoiceField(
        queryset=STOCK_CHOICES, to_field_name="company_abbreviation"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["amount"].widget.attrs.update({"class": "form-control", "min": 1})
    ...
    def clean_value(self):
        ...
        current_balance = (
            Portfolio.objects.filter(portfolio_id=self.portfolio_id).first().balance
        )
