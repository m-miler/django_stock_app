...
class UsersTest(TestCase):
    ...
    def test_new_user_register_function(self):
        ...
        response = self.client.post(reverse('register'), data={'username': 'NewUser0',
                                                               'email': 'test@test.pl',
    ...
    def test_should_not_create_the_same_users(self):
        ...
        form = UserRegisterForm(data={'username': 'TestUser0',
                                      'email': 'test@test.pl',
                                      'password1': 'test1234',
                                      'password2': 'test1234'})
    ...
    def test_if_user_can_log_in(self):
        ...
        response = self.client.post(reverse('login'), data={'username': 'TestUser0', 'password': 'test1234'},
                                    follow=True)
    ...
    def test_user_form_credentials_check(self):
        ...
        form = CustomLoginForm(data={'username': 'WrongUserName', 'password': 'WrongPassword'})
        self.assertFalse(form.is_valid())
