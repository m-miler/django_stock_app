...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for company in companies:
            ...
            stock_factories.StockPriceFactory.create_batch(30, company_abbreviation=company)

        wig = stock_factories.CompanyFactory(company_abbreviation='WIG20', company_full_name='WIG20')
        stock_factories.StockPriceFactory.reset_sequence(1, force=True)
